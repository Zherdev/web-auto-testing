...
/**
 * Второй тест, ДЗ к лекции 6, задание 2.2, Тинькофф Вакансии.
...
public class SecondTest extends BaseRunner {
    ...
    public void test1() {
        ...
        tinkoffVacancies.clickNothing();
        tinkoffVacancies.checkError(tinkoffVacancies.name,
                "Максимальное количество символов – 133");

        tinkoffVacancies.typeValue(tinkoffVacancies.birthday, "99999999");
        tinkoffVacancies.clickNothing();
        tinkoffVacancies.checkError(tinkoffVacancies.birthday,
        ...
        tinkoffVacancies.clickNothing();
        tinkoffVacancies.checkError(tinkoffVacancies.email,
                "Введите корректный адрес эл. почты");

        tinkoffVacancies.typeValue(tinkoffVacancies.phone, "0000000000");
        tinkoffVacancies.clickNothing();
        tinkoffVacancies.checkError(tinkoffVacancies.phone,
